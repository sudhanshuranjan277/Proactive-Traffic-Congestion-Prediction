...
class StandardScaler:
    """
    Standardize numeric values using:

    scaled_value = (value - mean) / standard_deviation

    Defined in preprocessing module so scaler objects
    can be safely serialized and loaded by predictor.
    """
...
class TrafficPreprocessor:
    ...
    def prepare_dataset(
        ...
        """
        Validate numeric values and sort
    ...
    def create_sequences(
        ...
        """
        Create independent chronological
        sequences for every location and junction.
        """
        ...
        for (
            location_id,
            junction_id,
        ), junction_data in grouped_dataset:
        ...
        if not input_sequences:
            ...
            raise ValueError(
                ...
                "Dataset may be too small for "
                "the configured lookback and "
                "prediction horizon."
            )
